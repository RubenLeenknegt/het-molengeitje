...
$feature_split = get_field('secondary_feature_split');
    ...
    <section class="px-6 py-16 sm:px-10 sm:py-18 md:px-14 md:py-20 lg:px-20 lg:py-10">
        <div class="mx-auto flex w-full max-w-[1440px] flex-col gap-6 lg:flex-row lg:items-stretch lg:gap-5">
            ...
            <div class="order-2 w-full lg:order-1 lg:basis-7/12">
                <div class="h-full bg-[color:var(--color-accent-bg)] p-8 sm:p-10 md:py-14 md:ps-14 md:pe-20 lg:py-20 lg:px-25 2xl:pr-70 text-black rounded-3xl md:rounded-3xl lg:rounded-[24px_120px_120px_24px]">
                    <?php if ($title) : ?>
