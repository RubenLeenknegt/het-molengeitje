...
<footer class="relative min-h-screen bg-cover bg-center text-white" style="background-image: url('<?php echo esc_url($footer_bg_url); ?>');">
        ...
        <div class="flex flex-1 flex-col gap-10 lg:flex-row lg:gap-16">
                    ...
                    <div>
                        ...
                        <?php if ($left_menu_exists) : ?>
                            ...
                            wp_nav_menu([
                                ...
                                'container'      => false,
                                'menu_class'     => 'mt-2 flex flex-col text-white/90',
                                'fallback_cb'    => false,
                                'depth'          => 1,
                            ]);
                            endif;
            ...
            <div class="flex w-full max-w-full flex-col gap-6 sm:w-96">
                ...
                <div class="flex flex-col rounded-3xl bg-black p-8 text-white">
                    ...
                    <div class="mt-6">
                        <a class="btn-primary btn-primary--light" href="/route">
                            <span>Route</span>
                            <span class="btn-arrow">
                                <?php echo file_get_contents($cta_arrow_svg); ?>
                            </span>
    ...
    <div class="relative z-10 mx-auto flex w-full max-w-[1440px] flex-col items-start justify-between gap-4 px-6 py-6 text-sm text-white/50 sm:flex-row sm:items-center sm:px-10 md:px-14 lg:px-20">
        <div class="flex items-center gap-2">
            <span class="text-base">©</span>
            <span>Copyright <?php echo esc_html(date('Y')); ?> Het molengeitje</span>
        </div>

        <a class="inline-flex items-center text-white/50 hover:text-white" href="https://www.instagram.com/" aria-label="Instagram">
            <span class="dashicons dashicons-instagram" style="font-size: 2rem; width: 2rem; height: 2rem;"></span>
        </a>
    </div>
