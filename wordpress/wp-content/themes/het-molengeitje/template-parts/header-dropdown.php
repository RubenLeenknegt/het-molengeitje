...
>
    <div class="mx-auto grid w-full max-w-[1440px] gap-8 px-6 py-8 sm:px-10 md:grid-cols-[minmax(0,1fr)_320px] md:px-14 md:pb-18 lg:px-8">
        ...
        <div class="hidden lg:flex flex-col md:w-96 items-start gap-2.5 lg:-ml-20">
            ...
            <div class="flex items-center justify-between gap-4 w-96 h-26 rounded-3xl p-8 transition-colors bg-black text-white">
                <h3 class="text-xl font-heading text-white">Routeplanner</h3>
                <a href="/route-planner/" class="btn-primary btn-primary--light hidden md:inline-flex">
                    <span class="btn-arrow btn-arrow--light">
                        <?php echo file_get_contents(get_template_directory() . '/assets/media/svg/cta-arrow.svg'); ?>
                    </span>
                </a>
            </div>
